...
fintrack-suppliermanagement-service documentation Version: 1.0.1

Scope
This document provides a structured architectural overview of the supplierManagement microservice, detailing its configuration, data model, authorization logic, business rules, and API design. It has been automatically generated based on the service definition within Mindbricks, ensuring that the information reflects the source of truth used during code generation and deployment.
...
SupplierManagement Service Settings Edit
...
Favicon: /favicon.ico
The service uses a PostgreSQL database for data storage, with the database name set to fintrack-suppliermanagement-service.
...
supplier	Represents a business-specific supplier. Each supplier is associated with a single business (tenant) and includes identification, contact, and optional notes for use in purchase workflows and reporting.	accessProtected	Yes
supplier Data Object
Object Overview
Description: Represents a business-specific supplier. Each supplier is associated with a single business (tenant) and includes identification, contact, and optional notes for use in purchase workflows and reporting.
...
Composite Indexes
supplier_fast_search: [name, taxNumber] This composite index is defined to optimize query performance for complex queries involving multiple fields.
...
address	Text	No	Supplier's legal or correspondence address (may include free formatting; recommended multi-line)
contactEmail	String	No	Contact person's email address at the supplier
contactName	String	No	Primary contact's name at the supplier organization
name	String	Yes	Supplier's official (display) name
notes	Text	No	Internal notes/comments about the supplier; not normally exposed outside the business
phone	String	No	Main phone number for supplier or contact person
taxNumber	String	No	Tax/VAT identification number for the supplier, if applicable
...
address contactEmail contactName name notes phone taxNumber businessId
...
Business Logic
supplierManagement has got 6 Business APIs to manage its internal and crud logic. For the details of each business API refer to its chapter.
...
Function Name: m2mCreateSupplier
Login Required: No
REST Settings:

Path: /m2m/supplier/create
Method:
m2mBulkCreateSupplier
Configuration:

Function Name: m2mBulkCreateSupplier
Login Required: No
REST Settings:

Path: /m2m/supplier/bulk-create
Method:
m2mUpdateSupplierById
Configuration:

Function Name: m2mUpdateSupplierById
Login Required: No
REST Settings:

Path: /m2m/supplier/update/:id
Method:
m2mDeleteSupplierById
Configuration:

Function Name: m2mDeleteSupplierById
Login Required: No
REST Settings:

Path: /m2m/supplier/delete/:id
Method:
m2mUpdateSupplierByQuery
Configuration:

Function Name: m2mUpdateSupplierByQuery
Login Required: No
REST Settings:

Path: /m2m/supplier/update-by-query
Method:
m2mDeleteSupplierByQuery
Configuration:

Function Name: m2mDeleteSupplierByQuery
Login Required: No
REST Settings:

Path: /m2m/supplier/delete-by-query
Method:
m2mUpdateSupplierByIdList
Configuration:

Function Name: m2mUpdateSupplierByIdList
Login Required: No
REST Settings:

Path: /m2m/supplier/update-by-id-list
Method:
Service Library
Functions
...
Edge Functions
m2mCreateSupplier.js
module.exports = async (request) => {
        const { createSupplier } = require("dbLayer");
        const context = { session: request.session, requestId: request.requestId };
        const data = request.body?.data || request.data || request;
        const result = await createSupplier(data, context);
        return { status: 200, content: result };
      }
m2mBulkCreateSupplier.js
module.exports = async (request) => {
        const { createBulkSupplier } = require("dbLayer");
        const context = { session: request.session, requestId: request.requestId };
        ...
        const result = await createBulkSupplier(dataList, context);
        return { status: 200, content: result };
      }
m2mUpdateSupplierById.js
module.exports = async (request) => {
        const { updateSupplierById } = require("dbLayer");
        const context = { session: request.session, requestId: request.requestId };
        ...
        const result = await updateSupplierById(id, dataClause, context);
        return { status: 200, content: result };
      }
m2mDeleteSupplierById.js
module.exports = async (request) => {
        const { deleteSupplierById } = require("dbLayer");
        const context = { session: request.session, requestId: request.requestId };
        const id = request.body?.id || request.params?.id || request.id;
        if (!id) {
          return { status: 400, message: "ID is required" };
        }
        const result = await deleteSupplierById(id, context);
        return { status: 200, content: result };
      }
m2mUpdateSupplierByQuery.js
module.exports = async (request) => {
        const { updateSupplierByQuery } = require("dbLayer");
        const context = { session: request.session, requestId: request.requestId };
        const dataClause = request.body?.dataClause || request.dataClause || request.body;
        ...
        const result = await updateSupplierByQuery(dataClause, query, context);
        return { status: 200, content: result };
      }
m2mDeleteSupplierByQuery.js
module.exports = async (request) => {
        const { deleteSupplierByQuery } = require("dbLayer");
        const context = { session: request.session, requestId: request.requestId };
        const query = request.body?.query || request.query || {};
        if (!query || typeof query !== "object" || Object.keys(query).length === 0) {
          return { status: 400, message: "Query is required and must be a non-empty object" };
        }
        const result = await deleteSupplierByQuery(query, context);
        return { status: 200, content: result };
      }
m2mUpdateSupplierByIdList.js
module.exports = async (request) => {
        const { updateSupplierByIdList } = require("dbLayer");
        const context = { session: request.session, requestId: request.requestId };
        ...
        const result = await updateSupplierByIdList(idList, dataClause, context);
        return { status: 200, content: result };
      }
Templates
